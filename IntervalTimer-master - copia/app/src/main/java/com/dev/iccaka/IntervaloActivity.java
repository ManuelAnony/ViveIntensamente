...
public class IntervaloActivity extends Activity {
    ...
    // Views from activity_intervalo.xml / Vistas desde activity_intervalo.xml
    ...
    public static final int DEFAULT_SETS = 01;
    public static final int DEFAULT_WORK_SECS = 01;
    public static final int DEFAULT_WORK_MINS = 0;
    public static final int DEFAULT_REST_SECS = 01;
    public static final int DEFAULT_REST_MINS = 0;
    public static final String DEFAULT_FILE_NAME = "parameters";

    // Custom methods to get the parameters on the screen / Métodos personalizados para obtener los parámetros en la pantalla.
    ...
    // Gets the current parameters values back to their default ones / Obtiene los valores de los parámetros actuales a sus valores predeterminados
    ...
    private void getViews() {
        //get the views from the R class / obtener las vistas de la clase R
        //Buttons of Activity main / Botones de Activity main
        ...
        // TextView of Activity main / Cuadro de texto de Activity main
    ...
    private void attachListenersToButtons() {
        //attach listeners to all buttons / adjuntar oyentes a todos los botones
    ...
    // Métodos para incrementar correctamente los parámetros cuando hace clic en sus botones correspondientes
    ...
    // Método para iniciar el temporizador y pasar los parámetros a la clase TimerActivity.
    @SuppressLint("ApplySharedPref")
    ...
    public void onBackPressed() {
        ...
        if (this.isBackPressedTwice) {
            ...
            Toast.makeText(IntervaloActivity.this, "Press BACK once again to exit", Toast.LENGTH_SHORT).show();
